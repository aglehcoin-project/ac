...
"""Verify that starting aglehcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aglehcoin with -h for help text")
        ...
        self.log.info("Start aglehcoin with -version for version information")
        ...
        self.log.info("Start aglehcoind with -fakearg to make sure it does not start")
