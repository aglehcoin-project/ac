# Support for Output Descriptors in Aglehcoin Core

Since Aglehcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Aglehcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Aglehcoin Core wallets, a convenience function `combo` is
