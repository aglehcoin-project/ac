...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " aglehcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  aglehcoin-tx [options] <hex-tx> [commands]  Update hex-encoded aglehcoin transaction\n" +
            "or:     aglehcoin-tx [options] -create [commands]   Create hex-encoded aglehcoin transaction\n" +
            "\n";
